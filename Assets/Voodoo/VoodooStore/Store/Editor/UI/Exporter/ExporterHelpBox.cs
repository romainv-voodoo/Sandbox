...
//		objectType = "Script";
//		message = "Assets/Voodoo/EasyAnchors.cs has an incorrect path. Please put it under the following folder : Scripts";
//		messageType = MessageType.Warning;
//		projectObject = AssetDatabase.LoadAssetAtPath<Object>("Assets/Voodoo/EasyAnchors.cs");
		...
		private void DisplayRepairButton()
		{
			...
			if (GUILayout.Button(ContentHelper.UIRepair, GUILayout.Height(38), GUILayout.Width(38)))
			{
				OnFixAsked();
			}
		}
